...
from simplecv1.module import resnet
from simplecv1.module import fpn
import math
from simplecv1.module import loss
from simplecv1.module.resnet import plugin_context_block2d
...
class SemanticFPN(CVModule.CVModule):
        ...
        if self.training:
            ...
            if self.config.loss.binary_mode:
                ...
                with paddle.no_grad():
                    ...
                    loss_dict['iou-1'] = inter / paddle.max(union - inter, paddle.to_tensor(1e-6))
            else:
...
if __name__ == '__main__':
    from simplecv1.util.param_util import count_model_parameters
