...
from data1.isaid import RemoveColorMap
from simplecv1.api.preprocess import segm, comm
...
config = dict(
    ...
    data=dict(
        train=dict(
            ...
            params=dict(
                image_dir='/home/aistudio/data/data170962/train/images/images',
                mask_dir='/home/aistudio/data/data170962/train/masks/images',
                patch_config=dict(
                    patch_size=896,
                    stride=512,
                ),
        ...
        test=dict(
            type='ISAIDSegmmDataLoader',
            params=dict(
                image_dir='./isaid_segm/val/images/images',
                mask_dir='./isaid_segm/val/masks/images',
                patch_config=dict(
                    patch_size=896,
                    stride=512,
                ),
