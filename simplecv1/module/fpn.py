...
from simplecv1.init import  kaiming_uniform_, constant_
...
class FPN(nn.Layer):
    ...
    def forward(self, x):
        ...
        for feature, inner_block, layer_block in zip(
            ...
            if not inner_block:
                continue
        #     print("before",last_inner.shape)
            inner_top_down = F.interpolate(last_inner, scale_factor=2, mode="nearest")
        #     print("last",inner_top_down.shape)
            inner_lateral = getattr(self, inner_block)(feature)
        #     print("inner_later {} innner_top_down {}".format(inner_lateral.shape, inner_top_down.shape))
