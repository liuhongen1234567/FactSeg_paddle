...
from simplecv1.init import kaiming_uniform_, constant_, kaiming_normal_
...
class ResNet(nn.Layer):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        #     print("m",m)
        #     print("m",m,isinstance(m, nn.Conv2D) )
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        resnet_path ='/home/aistudio/data/data170962/resnet50_paddle.pdparams'
        state_dict=paddle.load(resnet_path)
